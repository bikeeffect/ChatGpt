  ...
  return (
    <div className="relative">
      <div className="container p-8 mx-auto xl:px-0">
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-3 justify-items-start">
          {/* Policy */}
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              ...
              <a
                ...
                href="https://www.chatgptfinder.app/privacy"
              >
                Privacy
              </a>
            </div>
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              ...
              <a
                className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-emerald-500 focus:text-emerald-500 focus:bg-emerald-100 focus:outline-none dark:focus:bg-trueGray-700"
                href="mailto:volumedown0@gmail.com"
              >
                <div className="flex flex-row items-center">
                  ...
                  <p className="px-1">volumedown0@gmail.com</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright &copy; 2024. Made with ♥ by{' '}
          <a href="https://chatgptfinder.app/" target="_blank" rel="noopener">
            chatgptfinder.app
          </a>
        </div>
      </div>
