export default function Footer() {
  return (
    <div className="relative">
      <div className="container px-4 py-8 md:p-8 mx-auto xl:px-0">
        <div className="flex flex-wrap max-w-screen-xl gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 justify-center">
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              ...
              <a
                className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-emerald-500 focus:text-emerald-500 focus:bg-emerald-100 focus:outline-none dark:focus:bg-trueGray-700"
                href="https://www.chatgptfinder.app/contact"
              >
                Contact Us
              </a>
              <a
                className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-emerald-500 focus:text-emerald-500 focus:bg-emerald-100 focus:outline-none dark:focus:bg-trueGray-700"
                href="mailto:contact@chatgptfinder.app"
              >
                <div className="flex flex-row items-center">
                  ...
                  <p className="px-1 break-all">contact@chatgptfinder.app</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright &copy; 2026. Made with ♥ by{' '}
